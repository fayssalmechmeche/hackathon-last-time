        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-muted-foreground text-sm">Fichiers traités</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-foreground mb-2">
                150K<span className="text-green-500">+</span>
              </div>
              <div className="text-muted-foreground text-sm">Utilisateurs satisfaits</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-foreground mb-2">
                10M<span className="text-green-500">+</span>
              </div>
              <div className="text-muted-foreground text-sm">Conversions réussies</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-foreground mb-2">
                24/7
